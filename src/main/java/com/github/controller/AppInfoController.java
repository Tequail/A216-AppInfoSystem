...
public class AppInfoController {
    ...
    public String appList(HttpServletRequest request, @ModelAttribute QueryAppInfoVO queryAppInfoVO){
        ...
        if (jedis.exists("pages") && jedis.exists("statusList") && jedis.exists("flatFormList") && jedis.exists("categoryLevel1List") && queryAppInfoVO.getPageIndex() == Integer.parseInt( jedis.get("pageIndex"))){
            // 在redis中查询这些数据
